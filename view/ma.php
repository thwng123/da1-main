...
<div class="box-login">
    <form action="index.php?act=ma" method="post" id="login-form">
        <div class="form-group">
            <label for="username">Mã xác nhận của bạn</label><br>
            <input type="text" id="username" name="ma"  placeholder="Mã xác nhận">
            <div style="color: red;font-weight:500"><?php if(isset(   $errors['ma'])){
                 echo  $errors['ma'];
            } ?></div>
        </div>
        ...
        <div class="form-group dangnhap">
            ...
            <input type="submit" name="btnsumbit" class="btn" value="Gửi Mã">
